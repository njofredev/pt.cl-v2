        ...
        <AnimatePresence>
          {showPromo && (
            <motion.div
              ...
              className="bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white overflow-hidden relative z-[60] shadow-md border-b border-slate-950/40"
            >
              <div className="container mx-auto px-4 py-2 md:py-2.5 flex items-center justify-center gap-x-2 sm:gap-x-4 text-center relative pr-28 md:pr-32">
                <SmilePlus className="w-5 h-5 shrink-0 hidden sm:block text-[#ff6b00] animate-pulse" />
                <p className="text-[9px] sm:text-[11px] md:text-xs font-bold tracking-wide flex flex-wrap items-center justify-center gap-x-1 text-white/90">
                  <a
                    ...
                    className="hidden md:inline-flex items-center bg-[#ff6b00]/25 text-[#ff8c3a] px-2 py-0.5 rounded-full text-[9px] mr-1 font-black border border-[#ff6b00]/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
                  >
                    <Megaphone className="w-2.5 h-2.5 mr-1 -rotate-12 shrink-0" /> PROMOCIÓN LIMITADA
                  </a>
                  <span className="flex items-center gap-1">
                    <ClipboardPlus className="w-3.5 h-3.5 text-[#ff6b00] shrink-0 inline-block relative -top-[0.5px]" />
                    Pack Dental: Evaluación + Limpieza + RX Bitewing Bilateral por
                  </span>
                  <span className="text-[#ff6b00] text-xs sm:text-sm font-black flex items-center ml-1 underline underline-offset-2">
                    $24.000.-
                  </span>
                ...
                <div className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 flex items-center gap-x-1 sm:gap-x-2">
                  <a
                    ...
                    className="bg-[#ff6b00] text-white hover:bg-[#e05e00] px-2 sm:px-4 py-1 rounded-full text-[8px] sm:text-[10px] font-black uppercase hover:scale-105 transition-all shrink-0 shadow-sm flex items-center gap-1 active:scale-95"
                  >
